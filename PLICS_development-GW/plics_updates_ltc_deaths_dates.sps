...
*****************************************************start here**********************************************.
*get input file .
get file='/conf/hscdiip/01-Source-linkage-files/source-episode-file-20'+!FY+'.sav'.
...
*For episode.
delete variables deceased derived_datedeath.
EXECUTE.
...
add files file=*
   /keep year to deathdiag10 deathdiag11 ALL.
EXECUTE.

*For INDIVIDUAL.
add files file=*
   /keep year to age deceased_flag date_death ALL.
EXECUTE.


*save file.
*FOR EPISODE.
save outfile='source-episode-file-20'+ !FY + '.sav'
/compressed.
 ...
 * get file='source-episode-file-20'+ !FY + '.sav'.
...
*CD to output directory.
CD '/conf/linkage/output/gemma/PLICS_updates/'.
