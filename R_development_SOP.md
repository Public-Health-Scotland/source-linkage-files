...
- [spelling](https://github.com/Public-Health-Scotland/source-linkage-files/blob/master/.github/workflows/spelling.yml) - This is a complicated (set of) workflows, see the wiki - [github.com/check-spelling/check-spelling/wiki](https://github.com/check-spelling/check-spelling/wiki/) to find out more as well as how to customise. It should check any new commit for spelling mistakes, usign a number of dictionaries plus a custom list we've given it, and then highlight any typos.
