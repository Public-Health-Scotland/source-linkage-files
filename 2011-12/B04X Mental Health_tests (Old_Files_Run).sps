...
If sysmis(record_keydate2) Missing_End_date = 1.
...
aggregate outfile = SLFnew
    ...
    /Mean_Age = mean(age)
    /n_episodes = n
    /n_missing_end_dates = Sum(Missing_End_date)
...
get file = '/conf/hscdiip/01-Source-linkage-files/source-episode-file-20' + !FY + '.zsav'
    ...
    cost_total_net yearstay stay.

*Removing these for running old files
apr_beddays to mar_beddays apr_cost to mar_cost.
...
match files
    ...
    /file = SLFnew
    /By Measure.
Dataset Name MentalHealthComparison.
