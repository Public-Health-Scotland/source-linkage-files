...
#'
#' @description Convert a year vector from financial year '1718' to the
#' alternate format '2017'.
#'
...
#'
#' @description Convert a year vector from the alternate format '2017' to
#' financial year format '2017'.
#'
