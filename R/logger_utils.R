...
log_slf_event <- function(stage = c("read", "process", "test"),
  ...
  file_name <- dplyr::recode_values(
    ...
    "nrs_deaths" ~ "NRS Deaths",
    "dn" ~ "District Nursing",
    "dn_cost_lookup" ~ "District Nursing Costs",
    "dn_contact_lookup" ~ "District Nursing Contacts",
    "hscp_pop_lookup" ~ "HSCP Population Lookup",
    ...
    "hscp_locality" ~ "HSCP Localities",
    "simd" ~ "SIMD",
    "datazone_pop" ~ "DataZone Population",
    "gpprac_opendata" ~ "GP Practice Open Data",
