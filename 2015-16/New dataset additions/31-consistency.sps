...
*match on using pc8.
match files file=*
   /table ='/conf/linkage/output/lookups/Unicode/Geography/Urban Rural Classification/postcode_urban_rural_2013_2014.sav'   
   /by pc8
...
**********************************************************.
*delete variables.
delete variables WARD urbrur_8 ukparl_con sparl_con easting northing deceased derived_datedeath.
EXECUTE.
**********************************************************.
