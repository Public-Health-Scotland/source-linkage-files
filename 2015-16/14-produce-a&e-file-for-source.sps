* Create A&E costed extract in suitable format for Source Linkage Files.
* Modified version of previous read in files used to create A&E data for Source Linkage Files. 
...
GET DATA  /TYPE=TXT
  /FILE=
    "/conf/hscdiip/DH-Extract/a_&_e_all_scotland_episode_level_extract_for_source_file_production_201516.csv"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS=","
  /QUALIFIER='"'
...
************extra code to fix postcodes with 5 characters.
string pc7_2 (a7).
...
save outfile = !file + 'aande_file_for_source-201516.sav' 
 /keep year recid record_keydate1 record_keydate2 chi gender dob prac hbpraccode pc7 hbrescode lca chp datazone location hbtreatcode 
       ae_arrivaltime ae_arrivalmode ae_refsource ae_attendcat ae_disdest ae_patflow ae_placeinc ae_reasonwait ae_bodyloc ae_alcohol
       alcohol_adm submis_adm falls_adm selfharm_adm cost_total_net age
       april_cost may_cost june_cost july_cost august_cost sept_cost 
...
get file = !file + 'aande_file_for_source-201516.sav'.
