...
GET DATA  /TYPE=TXT
  /FILE=
    "/conf/hscdiip/DH-Extract/maternity_all_scotland_episode_level_extract_for_source_file_production_201516."+
    "csv"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS=","
...
save outfile = !file + 'maternity_temp.sav'.

get file = !file + 'maternity_temp.sav'.
...
compute year = '1516'.
compute recid = '02B'.
if (CIJInpatientDayCaseIdentifierCode eq 'IP') newcis_ipdc = 'I'.
if (CIJInpatientDayCaseIdentifierCode eq 'DC') newcis_ipdc = 'D'.
...
save outfile = !file + 'maternity_temp2.sav'
...
get file = !file + 'maternity_temp2.sav'.
save outfile = !file + 'maternity_file_for_source-201516.sav'
 /compressed. 


* Housekeeping. 
erase file = !file + 'maternity_temp.sav'.
erase file = !file + 'maternity_temp2.sav'.
