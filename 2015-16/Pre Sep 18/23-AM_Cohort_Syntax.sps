...
get file = '/conf/acnd_testing/source-episode-file-20'+!FY+'.sav'.
...
save outfile = '/conf/acnd_testing/Patient_Demographic_Cohort_' + !FY + '.sav'
...
match files file = *
/table='/conf/linkage/output/lookups/clinical/specialty/copspecs.sav'
/by spec.
execute.
...
save outfile =  '/conf/acnd_testing/GP_Practice_Cohort_Updated_With_Pattype_'+!FY+'.sav'.

***********************************************************************************************************************************.

*Adjusting Cohorts based on Cost.

get file = '/conf/acnd_testing/GP_Practice_Cohort_Updated_With_Pattype_'+!FY+'.sav'.
...
save outfile = '/conf/acnd_testing/GP_Practice_Service_Use_Cohorts_' + !FY + '.sav'
   /keep CHI Service_Use_Cohort.

*save outfile = '/conf/irf/11-Development team/GP_Practice_Service_Use_Cohorts_' + !FY + '.sav'
   /keep CHI Service_Use_Cohort.

get file ='/conf/acnd_testing/GP_Practice_Service_Use_Cohorts_'+!FY+'.sav'.
