...
GET DATA  /TYPE=TXT
  /FILE="/conf/hscdiip/DH-Extract/nrs_death_registrations_all_scotland_episode_level_extract_for_source_file_production_201516.csv"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS=","
  /QUALIFIER='"'
...
save outfile = !file + 'deaths_extract_source-201516.sav'
 /compressed.


get file = !file + 'deaths_extract_source-201516.sav'.
...
save outfile = !file + 'deaths_extract_for_source-201516.sav'.

get file = !file + 'deaths_extract_for_source-201516.sav'.
...
* Housekeeping.
erase file = !file + 'deaths_extract_source-201516.sav'.
