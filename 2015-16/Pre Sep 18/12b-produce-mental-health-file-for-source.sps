...
GET DATA  /TYPE=TXT
  /FILE="/conf/hscdiip/DH-Extract/mental_health_all_scotland_episode_level_extract_for_source_file_production_201516.csv"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS=","
  /QUALIFIER='"'
...
frequency variables = newcistadm newcis_admtype.
...
save outfile = !file + 'mental_health_file_for_source-201516.sav'
 /compressed. 

get file = !file + 'mental_health_file_for_source-201516.sav'.
