test_that("fix_sc_start_dates works for various cases", {
  ...
  expect_equal(fix_sc_start_dates(as.Date(c(NA, NA, NA, NA)),
  ...
  expect_equal(fix_sc_start_dates(as.Date(c("2019-04-01", "2019-07-01", "2019-10-01", "2020-01-01")),
...
test_that("fix_sc_end_dates works for various cases", {
  ...
  expect_equal(fix_sc_end_dates(as.Date(c("2018-04-30", "2019-05-30", "2020-06-30", "2021-07-30")),
  ...
  # Do not replace
  expect_equal(fix_sc_end_dates(as.Date(c("2018-04-20", "2019-05-20", "2020-06-20", "2021-07-20")),
