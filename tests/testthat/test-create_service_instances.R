test_that("Flags are assigned correctly", {
  ...
  # Emergency
  expect_equal(test_output$emergency_instances,
               c(TRUE, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE))

  # Elective
  expect_equal(test_output$elective_instances,
               c(TRUE, TRUE, FALSE, TRUE, TRUE, TRUE, FALSE))

  # Elective inpatient
  expect_equal(test_output$elective_inpatient_instances,
               c(FALSE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE))

  # Elective daycase
  expect_equal(test_output$elective_daycase_instances,
               c(FALSE, FALSE, FALSE, TRUE, FALSE, FALSE, FALSE))

  # Death flags
  expect_equal(test_output$death_flag,
