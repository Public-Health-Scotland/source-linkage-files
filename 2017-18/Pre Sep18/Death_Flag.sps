*Get source episode file 201718.
get file='/conf/hscdiip/01-Source-linkage-files/source-episode-file-201718.sav'.
...
exe.
if (recid eq 'PIS' and derived_datedeath lt 20170401) Flag=1.
exe.
...
GET DATA  /TYPE=TXT
  /FILE="/conf/sourcedev/Anita_temp/Death_derived/GRO death registrations all scotland episode "+
    "level extract for source file production.csv"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS=" ,"
  /QUALIFIER='"'
...
alter type derived_datedeath (F8).
if (recid='PIS' and derived_datedeath lt 20170401) derived_datedeath  eq 0.
exe.
...
string Flag(A1).
if derived_datedeath gt '20180331' derived_datedeath eq ''.
exe.
...
if (derived_datedeath lt 20170401) Flag_1=1.
EXECUTE.
select if Flag_1=1.
exe.
