...
GET DATA  /TYPE=TXT
   /FILE="/conf/hscdiip/DH-Extract/SCTASK0045835_extract_1_ltc.csv"
   /ENCODING='UTF8'
   /DELCASE=LINE
   /DELIMITERS=","
   /QUALIFIER='"'
...
save outfile = '/conf/sourcedev/Anita_temp/' + 'ltc_temp.zsav'
   /zcompressed.

get file = '/conf/sourcedev/Anita_temp/'  + 'ltc_temp.zsav'.
...
save outfile = '/conf/sourcedev/Anita_temp/' + 'LTCs_patient_reference_file.zsav'
...
get file = '/conf/sourcedev/Anita_temp/'  + 'LTCs_patient_reference_file.zsav'.

erase file = '/conf/sourcedev/Anita_temp/' + 'ltc_temp.zsav'.
