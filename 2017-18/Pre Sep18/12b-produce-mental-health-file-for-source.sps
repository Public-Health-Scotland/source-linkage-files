...
save outfile = !file + 'mh_temp2.zsav'
...
save outfile = !file + 'mh_monthly_costs_by_uri.zsav'
   /zcompressed.
...
save outfile = !file + 'mh_monthly_beddays_by_uri.zsav'
   /zcompressed.
...
match files file = *
   /table = !file + 'mh_monthly_beddays_by_uri.zsav'
   /by uri.
execute.

match files file = *
   /table = !file + 'mh_monthly_costs_by_uri.zsav'
   /by uri.
execute.
...
save outfile = !file + 'mh_temp3.zsav'
   /keep year recid record_keydate1 record_keydate2 chi gender dob prac hbpraccode pc7 hbrescode lca chp datazone location hbtreatcode
...
erase file = !file + 'mh_temp2.zsav'.
erase file = !file + 'mh_temp3.zsav'.
erase file = !file + 'mh_los_by_uri.zsav'.
erase file = !file + 'mh_monthly_beddays_by_uri.zsav'.
erase file = !file + 'mh_monthly_costs_by_uri.zsav'.
