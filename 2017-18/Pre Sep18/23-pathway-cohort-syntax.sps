...
get file = '/conf/sourcedev/Anita_temp/source-episode-file-20'+!FY+'.sav'.
...
save outfile = '/conf/sourcedev/Anita_temp/Patient_Demographic_Cohort_' + !FY + '.sav'
...
save outfile =  '/conf/sourcedev/Anita_temp/GP_Practice_Cohort_Updated_With_Pattype_'+!FY+'.sav'.

***********************************************************************************************************************************.

*Adjusting Cohorts based on Cost.

get file = '/conf/sourcedev/Anita_temp/GP_Practice_Cohort_Updated_With_Pattype_'+!FY+'.sav'.
...
save outfile = '/conf/sourcedev/Anita_temp/GP_Practice_Service_Use_Cohorts_' + !FY + '.sav'
   /keep CHI Service_Use_Cohort.

*save outfile = '/conf/irf/11-Development team/GP_Practice_Service_Use_Cohorts_' + !FY + '.sav'
   /keep CHI Service_Use_Cohort.

get file ='/conf/sourcedev/Anita_temp/GP_Practice_Service_Use_Cohorts_'+!FY+'.sav'.
