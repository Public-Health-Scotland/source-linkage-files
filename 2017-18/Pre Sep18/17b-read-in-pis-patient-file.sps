...
******************************************************************************************************.
GET DATA  /TYPE=TXT
   /FILE=!file + 'SCTASK0045835_extract_4_fy_2017.csv'
   /ENCODING='UTF8'
   /DELCASE=LINE
   /DELIMITERS=","
   /QUALIFIER='"'
...
sort cases  by upi.
exe.
save outfile = '/conf/sourcedev/Anita_temp/' + 'pis_' +!FY +'_patients.sav'
   /zcompressed.

get file = '/conf/sourcedev/Anita_temp/'+ 'pis_' +!FY +'_patients.sav'.
