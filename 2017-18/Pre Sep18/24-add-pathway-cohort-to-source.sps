...
*Last ran 18/05/18-Anita George.
...
match files file = '/conf/sourcedev/Anita_temp/source-episode-file-20'+!FY+'.sav'
   /table = '/conf/sourcedev/Anita_temp/Patient_Demographic_Cohort_' +!FY +'.sav'
   /table = '/conf/sourcedev/Anita_temp/GP_Practice_Service_Use_Cohorts_' +!FY+ '.sav'
   /by CHI.
execute.
