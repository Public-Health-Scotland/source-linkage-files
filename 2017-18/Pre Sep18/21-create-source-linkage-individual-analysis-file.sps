...
* Acute (SMR01) section.
get file = !CostedFiles + 'source-episode-file-20'+!FY+'.sav'.
...
aggregate outfile = * mode=addvariables 
 /break CHI
 /acute_dob gender acute_postcode acute_prac = last(dob gender2 pc7 gpprac).
execute.
...
aggregate outfile = * mode=addvariables 
 /break CHI
 /mat_dob gender mat_postcode mat_prac = last(dob gender2 pc7 gpprac).
execute.
...
aggregate outfile = * mode=addvariables 
 /break CHI
 /mentalh_dob gender mentalh_postcode mentalh_prac = last(dob gender2 pc7 gpprac).
execute.
...
aggregate outfile = * mode=addvariables 
 /break CHI
 /gls_dob gender gls_postcode gls_prac = last(dob gender2 pc7 gpprac).
execute.
...
aggregate outfile = * mode=addvariables 
 /break CHI
 /op_dob gender op_postcode op_prac = last(dob gender2 pc7 gpprac).
execute.
...
aggregate outfile = * mode=addvariables 
 /break CHI
 /ae_dob gender ae_postcode ae_prac = last(dob gender2 pc7 gpprac).
execute.
...
aggregate outfile = * mode=addvariables 
 /break chi
 /pis_dob gender pis_postcode pis_prac = last(dob gender2 pc7 gpprac).
execute.
...
* Do a temporary save.
save outfile = !file + 'temp-source-individual-file-20' + !FY +'.sav'. 
get file  = !file + 'temp-source-individual-file-20' + !FY +'.sav'. 
...
match files file = *
 /table = '/conf/sourcedev/Anita_temp/Deceased_patient_reference_file.zsav'
 /by chi.
execute.
...
match files file = *
 /table = !LTCfile + 'LTCs_patient_reference_file.zsav'
 /by chi.
execute.
...
if (arth_date gt '20180331') arth eq 0.
if (asthma_date gt '20180331') asthma eq 0.
if (atrialfib_date gt '20180331') atrialfib eq 0.
if (cancer_date gt '20180331') cancer eq 0.
if (cvd_date gt '20180331') cvd eq 0.
if (liver_date gt '20180331') liver eq 0.
if (copd_date gt '20180331') copd eq 0.
if (dementia_date gt '20180331') dementia eq 0.
if (diabetes_date gt '20180331') diabetes eq 0.
if (epilepsy_date gt '20180331') epilepsy eq 0.
if (chd_date gt '20180331') chd eq 0.
if (hefailure_date gt '20180331') hefailure eq 0.
if (ms_date gt '20180331') ms eq 0.
if (parkinsons_date gt '20180331') parkinsons eq 0.
if (refailure_date gt '20180331') refailure eq 0.
if (congen_date gt '20180331') congen eq 0.
if (bloodbfo_date gt '20180331') bloodbfo eq 0.
if (endomet_date gt '20180331') endomet eq 0.
if (digestive_date gt '20180331') digestive eq 0.
execute.

if (arth_date gt '20180331') arth_date eq ''.
if (asthma_date gt '20180331') asthma_date eq ''.
if (atrialfib_date gt '20180331') atrialfib_date eq ''.
if (cancer_date gt '20180331') cancer_date eq ''.
if (cvd_date gt '20180331') cvd_date eq ''.
if (liver_date gt '20180331') liver_date eq ''.
if (copd_date gt '20180331') copd_date eq ''.
if (dementia_date gt '20180331') dementia_date eq ''.
if (diabetes_date gt '20180331') diabetes_date eq ''.
if (epilepsy_date gt '20180331') epilepsy_date eq ''.
if (chd_date gt '20180331') chd_date eq ''.
if (hefailure_date gt '20180331') hefailure_date eq ''.
if (ms_date gt '20180331') ms_date eq ''.
if (parkinsons_date gt '20180331') parkinsons_date eq ''.
if (refailure_date gt '20180331') refailure_date eq ''.
if (congen_date gt '20180331') congen_date eq ''.
if (bloodbfo_date gt '20180331') bloodbfo_date eq ''.
if (endomet_date gt '20180331') endomet_date eq ''.
if (digestive_date gt '20180331') digestive_date eq ''.
execute.
...
* - run the code for the individal file for locality and cluster addition.
* - run the code to add on pathway cohort markers.
* - run the code to determine and add on HRI columns.   
...
save outfile = !CostedFiles + 'source-individual-file-20' + !FY + '.sav'.
get file = !CostedFiles + 'source-individual-file-20' + !FY + '.sav'.


*************************************************************************************************************************************************.
* Erase temporary files created throughout the program.
erase file =  !file + 'temp_acute_agg.sav'.
erase file =  !file + 'temp_mat_agg.sav'.
erase file =  !file + 'temp_mentalh_agg.sav'.
erase file =  !file + 'temp_gls_agg.sav'.
erase file =  !file + 'temp_op_agg.sav'.
erase file =  !file + 'temp_ae_agg.sav'.
erase file =  !file + 'temp_pis_agg.sav'.
erase file  = !file 'temp-source-individual-file-20' + !FY +'.sav'. 
