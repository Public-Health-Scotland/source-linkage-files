* Encoding: UTF-8.
get file = !Extracts_Alt + "/Delayed_Discharges/Jul16_Sep18DD_LinkageFile_withCosts.zsav"
    /Drop costcode linenodesc DDCostIncDirOH sourcefile.
...
save outfile = !Extracts + "DD_LinkageFile-20" + !FY + "_withCosts.zsav"
   /Drop hb la Correct_Dates No_End_Date
   /zcompressed.

get file = !Extracts + "DD_LinkageFile-20" + !FY + "_withCosts.zsav".
