...
save outfile = !Cohort_dir + "Demographic_Cohorts_" + !FY + ".zsav"
...
save outfile = !Cohort_dir + "Service_Use_Cohorts_" + !FY + ".zsav"
...
get file = !Cohort_dir + "Service_Use_Cohorts_" + !FY + ".zsav".
