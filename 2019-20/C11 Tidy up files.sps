...
erase file = !Year_dir + "temp-source-episode-file-1-" + !FY + ".zsav".
erase file = !Year_dir + "temp-source-episode-file-2-" + !FY + ".zsav".
erase file = !Year_dir + "temp-source-episode-file-3-" + !FY + ".zsav".
erase file = !Year_dir + "temp-source-episode-file-4-" + !FY + ".zsav".
erase file = !Year_dir + "temp-source-episode-file-5-" + !FY + ".zsav".
