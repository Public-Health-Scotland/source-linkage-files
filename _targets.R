...
list(
  ...
  tar_target(source_pc_lookup,
             process_lookup_postcode(spd_path = spd_data,
                                     simd_path = simd_data,
                                     locality_path = locality_data,
                                     write_to_disk = write_to_disk)),
  tar_target(source_gp_lookup,
             process_lookup_gpprac(open_data = gpprac_data,
  ...
  tarchetypes::tar_map(
    ...
    tar_target(source_sc_home_care, process_extract_home_care(all_hc_data,
                                                  ...
                                                  client_lookup = client_data,
                                                  write_to_disk = write_to_disk)),
    tar_target(source_sc_care_home, process_extract_care_home(all_ch_data),
                                                  year,
