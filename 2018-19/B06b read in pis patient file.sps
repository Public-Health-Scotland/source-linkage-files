...
Host Command = ["gunzip '" + !CSDExtractLoc + "_extract_6_fy_" + !altFY + ".csv'" ].

GET DATA  /TYPE=TXT
   /FILE = !CSDExtractLoc + "_extract_6_fy_" + !altFY + ".csv"
   /ENCODING="UTF8"
   /DELIMITERS=","
   /QUALIFIER='"'
...
Host Command = ["gzip '" + !CSDExtractLoc + "_extract_6_fy_" + !altFY + ".csv'" ].
