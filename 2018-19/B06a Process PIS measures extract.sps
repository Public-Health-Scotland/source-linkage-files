...
Host Command = ["gunzip '" + !CSDExtractLoc + "_extract_9_paid_data_fy_" + !altFY + ".csv'"].

GET DATA  /TYPE=TXT
   /FILE= !CSDExtractLoc + "_extract_9_paid_data_fy_" + !altFY + ".csv"
   /ENCODING="UTF8"
   /DELIMITERS=","
   /QUALIFIER='"'
...
Host Command = ["gzip '" + !CSDExtractLoc + "_extract_9_paid_data_fy_" + !altFY + ".csv'"].
