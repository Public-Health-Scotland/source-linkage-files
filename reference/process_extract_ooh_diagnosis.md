...
This will read and process the GP OOH Diagnosis extract, it will return
the final data and (optionally) write it to disk.

## Usage

``` r
process_extract_ooh_diagnosis(data, year)
```
