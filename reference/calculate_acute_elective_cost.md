...
A record is considered to have an Acute Elective cost if the recid is
01B, the CIJ patient type is Elective or the IPDC shows it is a day
case, and the specialty is not AB
