...
This will process year-specific BOXI NRS death file (written to disk),
and combine them together to get all years NRS file (Not written to
disk). Then join all NRS deaths with IT CHI death data to get an
all-year refined death file (written to disk).
