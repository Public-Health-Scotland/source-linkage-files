...
A record is considered to have an Outpatient cost if the recid is 00B.
The Outpatient Cost is defined as (total net cost - geriatric cost), and
the Total Outpatient Cost is the total net cost
...
A list with outpatient costs in index 1 and total outpatient costs in
index 2
