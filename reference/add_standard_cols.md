...
Add standard columns (DoB, postcode, gpprac, episodes, cost) to episode
file.
...
- episode:
  ...
  Whether to create prefix_episodes col, e.g. "Acute_episodes"

- cost:

  Whether to create prefix_cost col, e.g. "Acute_cost"
