...
Get the path to the service-use cohorts lookup, there is one lookup per
year.

## Usage

``` r
get_service_use_cohorts_path(year, update = latest_update(), ...)
```
...
The path to the service-use cohorts lookup as an
