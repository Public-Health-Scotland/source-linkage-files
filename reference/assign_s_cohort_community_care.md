...
If the record has a home care cost or community health cost greater than
zero, assign `TRUE`

## Usage

``` r
assign_s_cohort_community_care(community_health_cost)
```
...
- community_health_cost:
  ...
  A vector of community health costs

## Value

A boolean vector of Community Care cohort flags
