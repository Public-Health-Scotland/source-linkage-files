...
If the record does not have an elective inpatient flag and they have 3
or fewer elective instances, return `TRUE`.

## Usage

``` r
assign_s_cohort_limited_daycases(elective_inpatient_flag, elective_instances)
```

## Arguments

- elective_inpatient_flag:

  A vector of elective inpatient flags

- elective_instances:

  A vector of elective instances
