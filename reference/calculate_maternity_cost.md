...
A record is considered to have a Maternity cost if the recid is 02B or
the CIJ Patient type is Maternity

## Usage

``` r
calculate_maternity_cost(recid, cij_pattype, cost_total_net)
```
