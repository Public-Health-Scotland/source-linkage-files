...
- data:
  ...
  A data frame with the required variables.

- year:

  The year in standard SLF format.
...
- write_to_disk:
  ...
  Default `TRUE`, will write the lookup to the Cohorts folder defined by
  [get_slf_dir](https://public-health-scotland.github.io/source-linkage-files/reference/get_slf_dir.md).

## Value

The Demographics Cohorts lookup
