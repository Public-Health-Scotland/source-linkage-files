...
In this case, an elective inpatient is flagged if over half of the acute
elective cost is for elective inpatient procedures

## Usage

``` r
assign_elective_inpatient_flag(acute_elective_cost, elective_inpatient_cost)
```
...
A boolean vector indicating whether a record is an elective inpatient
one
