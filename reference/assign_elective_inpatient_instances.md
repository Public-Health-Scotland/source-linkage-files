...
An elective inpatient instance is defined as when the CIJ patient type
is Elective and the IPDC marker is I

## Usage

``` r
assign_elective_inpatient_instances(cij_pattype, cij_ipdc)
```
...
- cij_ipdc:
  ...
  A vector of CIJ IPDC markers

## Value

A boolean vector showing whether a record is an elective inpatient case
or not
