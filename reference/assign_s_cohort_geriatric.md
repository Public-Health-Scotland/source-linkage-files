...
If the record has a geriatric cost greater than zero, assign `TRUE`

## Usage

``` r
assign_s_cohort_geriatric(geriatric_cost)
```
...
- geriatric_cost:
  ...
  A vector of geriatric costs

## Value

A boolean vector of geriatric cohort flags
