...
If the record has a psychiatry cost greater than zero, assign `TRUE`

## Usage

``` r
assign_s_cohort_psychiatry(psychiatry_cost)
```
...
- psychiatry_cost:
  ...
  A vector of psychiatry costs

## Value

A boolean vector of psychiatry cohort flags
