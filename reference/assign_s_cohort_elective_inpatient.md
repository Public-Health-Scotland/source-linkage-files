...
If the record has a elective inpatient flag, assign `TRUE`

## Usage

``` r
assign_s_cohort_elective_inpatient(elective_inpatient_flag)
```
...
- elective_inpatient_flag:
  ...
  A vector of elective_inpatient costs

## Value

A boolean vector of elective inpatient cohort flags
