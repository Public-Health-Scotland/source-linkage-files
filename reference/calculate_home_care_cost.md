...
Please note: this function is currently not in use. A record is
considered to have a home care cost if the recid is in c("HC-", "HC + ",
"INS", "RSP", "MLS", "DC", "CPL")

## Usage

``` r
calculate_home_care_cost(recid, cost_total_net)
```
