...
If the record does not have an elective inpatient flag and they have 4
or more elective instances, return `TRUE`.

## Usage

``` r
assign_s_cohort_routine_daycase(elective_inpatient_flag, elective_instances)
```
