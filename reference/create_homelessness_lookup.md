...
Reads in the homelessness extract and creates a lookup at CHI level,
with one row per application start and end date for each CHI.
...
- homelessness_data:
  ...
  the processed homelessness data for the financial year (created with
