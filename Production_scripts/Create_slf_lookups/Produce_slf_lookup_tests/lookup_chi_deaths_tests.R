...
new_tests <- produce_slf_deaths_tests(readr::read_rds(get_slf_deaths_path()))
old_tests <- produce_slf_deaths_tests(readr::read_rds(get_slf_deaths_path(update = previous_update())))
