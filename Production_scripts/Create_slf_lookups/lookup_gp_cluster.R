...
gp_clusters_clean %>%
  # .zsav
  write_sav(get_slf_gp_cluster_path(update = latest_update, ext = "zsav", check_mode = "write"), compress = "zsav") %>%
  # .rds file
  write_rds(get_slf_gp_cluster_path(update = latest_update, check_mode = "write"), compress = "xz")
