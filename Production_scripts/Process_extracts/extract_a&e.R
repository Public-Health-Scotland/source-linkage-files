...
# Save as zsav file
outfile %>%
  write_sav(get_source_extract_path(year, "AE", ext = "zsav", check_mode = "write"), compress = "zsav") %>%
  # Save as rds file
  write_rds(get_source_extract_path(year, "AE", check_mode = "write"), compress = "xz")
