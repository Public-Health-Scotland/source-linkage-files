...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_1920", store = targets_store),
  ae = targets::tar_read("source_ae_extract_1920", store = targets_store),
  ...
  homelessness = targets::tar_read("source_homelessness_extract_1920", store = targets_store),
  maternity = targets::tar_read("source_maternity_extract_1920", store = targets_store),
  mental_health = targets::tar_read("source_mental_health_extract_1920", store = targets_store),
  outpatients = targets::tar_read("source_outpatients_extract_1920", store = targets_store),
  ...
  home_care = targets::tar_read("source_sc_home_care_1920", store = targets_store),
  at = targets::tar_read("source_sc_alarms_tele_1920", store = targets_store),
