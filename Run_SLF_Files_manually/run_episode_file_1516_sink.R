...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_1516", store = targets_store),
  ...
  mental_health = targets::tar_read("source_mental_health_extract_1516", store = targets_store),
  outpatients = targets::tar_read("source_outpatients_extract_1516", store = targets_store),
  ...
  at = targets::tar_read("source_sc_alarms_tele_1516", store = targets_store),
