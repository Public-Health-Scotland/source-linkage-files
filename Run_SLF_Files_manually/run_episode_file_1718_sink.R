...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_1718", store = targets_store),
  ...
  at = targets::tar_read("source_sc_alarms_tele_1718", store = targets_store),
  sds = targets::tar_read("source_sc_sds_1718", store = targets_store)
)
