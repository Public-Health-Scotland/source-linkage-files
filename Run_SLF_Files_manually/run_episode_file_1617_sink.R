...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_1617", store = targets_store),
  ...
  prescribing = targets::tar_read("source_prescribing_extract_1617", store = targets_store),
  ...
  at = targets::tar_read("source_sc_alarms_tele_1617", store = targets_store),
  sds = targets::tar_read("source_sc_sds_1617", store = targets_store)
)
