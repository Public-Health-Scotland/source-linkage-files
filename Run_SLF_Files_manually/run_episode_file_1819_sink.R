...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_1819", store = targets_store),
  ...
  homelessness = targets::tar_read("source_homelessness_extract_1819", store = targets_store),
  ...
  at = targets::tar_read("source_sc_alarms_tele_1819", store = targets_store),
  sds = targets::tar_read("source_sc_sds_1819", store = targets_store)
)
