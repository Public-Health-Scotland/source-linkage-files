...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_2425", store = targets_store),
  ae = targets::tar_read("source_ae_extract_2425", store = targets_store),
  cmh = targets::tar_read("source_cmh_extract_2425", store = targets_store),
  dn = targets::tar_read("source_dn_extract_2425", store = targets_store),
  deaths = targets::tar_read("source_nrs_deaths_extract_2425", store = targets_store),
  homelessness = targets::tar_read("source_homelessness_extract_2425", store = targets_store),
  ...
  care_home = targets::tar_read("source_sc_care_home_2425", store = targets_store),
  home_care = targets::tar_read("source_sc_home_care_2425", store = targets_store),
  at = targets::tar_read("source_sc_alarms_tele_2425", store = targets_store),
  sds = targets::tar_read("source_sc_sds_2425", store = targets_store)
)
