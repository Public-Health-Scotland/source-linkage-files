...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_2324", store = targets_store),
  ...
  prescribing = targets::tar_read("source_prescribing_extract_2324", store = targets_store),
  ...
  at = targets::tar_read("source_sc_alarms_tele_2324", store = targets_store),
