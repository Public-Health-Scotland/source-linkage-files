...
processed_data_list <- list(
  acute = targets::tar_read(
    "source_acute_extract_1617",
    store = targets_store
  ),
  ae = targets::tar_read(
    "source_ae_extract_1617",
    store = targets_store
  ),
  ...
  deaths = targets::tar_read(
    "source_nrs_deaths_extract_1617",
    store = targets_store
  ),
  homelessness = targets::tar_read(
    "source_homelessness_extract_1617",
    store = targets_store
  ),
  maternity = targets::tar_read(
    "source_maternity_extract_1617",
    store = targets_store
  ),
  mental_health = targets::tar_read(
    "source_mental_health_extract_1617",
    store = targets_store
  ),
  outpatients = targets::tar_read(
    "source_outpatients_extract_1617",
    store = targets_store
  ),
  gp_ooh = targets::tar_read(
    "source_ooh_extract_1617",
    store = targets_store
  ),
  prescribing = targets::tar_read(
    "source_prescribing_extract_1617",
    store = targets_store
  ),
  care_home = targets::tar_read(
    "source_sc_care_home_1617",
    store = targets_store
  ),
  home_care = targets::tar_read(
    "source_sc_home_care_1617",
    store = targets_store
  ),
  at = targets::tar_read(
    "source_sc_alarms_tele_1617",
    store = targets_store
  ),
