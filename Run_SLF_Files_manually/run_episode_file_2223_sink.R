...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_2223", store = targets_store),
  ...
  dn = targets::tar_read("source_dn_extract_2223", store = targets_store),
  ...
  outpatients = targets::tar_read("source_outpatients_extract_2223", store = targets_store),
  ...
  home_care = targets::tar_read("source_sc_home_care_2223", store = targets_store),
  at = targets::tar_read("source_sc_alarms_tele_2223", store = targets_store),
