...
processed_data_list <- list(
  acute = targets::tar_read("source_acute_extract_2122", store = targets_store),
  ...
  outpatients = targets::tar_read("source_outpatients_extract_2122", store = targets_store),
  ...
  care_home = targets::tar_read("source_sc_care_home_2122", store = targets_store),
  home_care = targets::tar_read("source_sc_home_care_2122", store = targets_store),
  at = targets::tar_read("source_sc_alarms_tele_2122", store = targets_store),
