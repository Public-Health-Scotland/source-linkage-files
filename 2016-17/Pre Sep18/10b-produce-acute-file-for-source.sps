...
match files file = *
 /table = !file + 'acute_line_number_by_uri_20' +!FY +'.sav'
 /by uri.
execute.
...
save outfile = !file + 'acute_for_source-20' +!FY +'.sav'
...
get file = !file + 'acute_for_source-20' +!FY +'.sav'.
...
erase file = !file + 'acute_line_number_by_uri_20' +!FY +'.sav'.
