...
*************************************************************************************************************************************************.
* File location for master PLICS file.
...
*TEMP LOCATION.
define !CostedFiles()
'/conf/irf/11-Development team/Dev00-PLICS-files/2016-17/'
!enddefine.

* temp storage - ORGINAL.
 * define !file()
...
*TEMP output.
define !file()
'/conf/linkage/output/jamiem09/PLICs/'
!enddefine.
...
frequency variables ipdc newpattype_cis newcis_ipdc.
...
* Do a temporary save.
save outfile = !file + 'tempCHImasterPLICS_Costed_20' + !FY +'.sav'. 
get file  = !file + 'tempCHImasterPLICS_Costed_20' + !FY +'.sav'. 
...
match files file = *
 /table = !Deathsfile + 'Deceased_patient_reference_file-Jan2017.sav'
 /by chi.
execute.
...
save outfile = !file + 'CHImasterPLICS_Costed_20'+!FY+'.sav' 
...
get file = !file + 'CHImasterPLICS_Costed_20'+!FY+'.sav'.
...
save outfile = !CostedFiles + 'CHImasterPLICS_Costed_201415.sav'.
get file = !CostedFiles + 'CHImasterPLICS_Costed_201415.sav'.
...
erase file  = !CostedFiles + 'tempCHImasterPLICS_Costed_201617.sav'.
