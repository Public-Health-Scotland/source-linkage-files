...
CD  '/conf/linkage/output/jamiem09/PLICs/'.  

******************************************************start here*******************************************.

get file= 'CHImasterPLICS_Costed_20' + !FY + '.sav'.
...
*match onto HRI file.
match files file=*
   /table = '/conf/sourcedev/HRI_lookup_' + !FY + '.sav'
   /by CHI.
EXECUTE.
...
save outfile = 'source-individual-file-20' + !FY + '.sav' /compressed.
...
*check if other individual files have pc7 or health_postcode.
