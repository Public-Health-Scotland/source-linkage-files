...
GET DATA  /TYPE=TXT
  /FILE="/conf/sourcedev/Anita_temp/DN/DN_source_extract_201617.csv"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS=" ,"
  /QUALIFIER='"'
...
save outfile='/conf/sourcedev/Anita_temp/DN_temp.sav'.
...
if hbtreatname='NHS FORTH VALLEY' cost_total_net =41.
if hbtreatname='NHS GREATER GLASGOW & CLYDE' cost_total_net =34.
if hbtreatname='NHS HIGHLAND' cost_total_net =241.
if hbtreatname='NHS LANARKSHIRE' cost_total_net =40.
if hbtreatname='NHS LOTHIAN' cost_total_net =57.
if hbtreatname='NHS TAYSIDE' cost_total_net =76.
exe.
*Tidying up.
...
save outfile='/conf/sourcedev/Anita_temp/DN/DN_for_source-201617.sav'
/keep 
year
recid
record_keydate1
...
get file='/conf/sourcedev/Anita_temp/DN/DN_for_source-201617.sav'.
