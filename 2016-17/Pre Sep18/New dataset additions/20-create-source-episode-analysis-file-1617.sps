...
get file = !source + "source-episode-file-20" + !FY + ".sav"
   /Drop deceased derived_datedeath arth to digestive_date simd2012score to CHP2011subarea DataZone2011 to SPARRA_RISK_SCORE.
...
get file = '/conf/sourcedev/source-episode-file20_'+ !FY + '.zsav'.
